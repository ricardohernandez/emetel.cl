            ...
            <ul class="sidenav__menu-dropdown">
               ...
               <li class="">
                  ...
                  <ul class="sidenav__menu-dropdown">
                     ...
                     <li><a  class="sidenav__menu-url" href="<?php echo base_url() ?>mantenedor_checklist_ftth">Checklist FTTH</a></li>
      ...
      <div class="container-fluid relative">
         <div class="flex-parent">
            ...
            <a href="<?php echo base_url() ?>" class="logo">
               <img class="logo_empresa logo_claro" src="<?php echo base_url();?>assets3/imagenes/logo_claro2.png" style="width:120px;margin-top:-5px!important;" alt="logo">
               <img class="logo_empresa logo_oscuro" src="<?php echo base_url();?>assets3/imagenes/logo_blanco2.png" style="width:120px;margin-top:-5px!important;" alt="logo">
            </a>
            <!-- MENU IZQUIERDA -->
